...
<body>
    <main>
        ...
        $int = (int) $num;
        $fra = $num - $int;
        // Ivan me orientou à abrir e fechar tags php para executar somente trechos de código php, como no exemplo abaixo, os echos foram removidos dando lugar as tags de php ternário, separando o que é html do que é php.
        ?>
